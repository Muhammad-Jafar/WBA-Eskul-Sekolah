    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= site_url('ekstrakurikuler') ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form action="<?= site_url('ekstrakurikuler/process') ?>" method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" name="<?= $page ?>" class="btn btn-success"><i class="fa fa-paper-plane"></i> Simpan</button>
