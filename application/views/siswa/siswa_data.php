...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Daftar Seluruh Siswa</h3><br><br>
            <div class="pull-right">
                <a href="<?= site_url('siswa/add') ?>" class="btn btn-primary btn-flat"><i class="fa fa-user-plus"></i> Tambah data</a>
                <a href="<?= site_url('siswa/cetak') ?>" class="btn btn-info btn-flat"><i class="fa fa-print"></i> Cetak data</a>
            </div>
            <!-- <div class="pull-left">
